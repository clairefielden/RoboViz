...
class Robot:
    ...
    def step(self, time, nodes, states):
        """
                ...
                Args:
                    `time`: amount of time elapsed since the neural network was fed with data
        ...
        for comp in reversed(self.components):
            ...
            if comp not in nodes:
                ...
                #calculate the change in distance from the accelaration
                ...
                #calculate accelaration but only change position by smaller and smaller as goes to core
